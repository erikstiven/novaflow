...
<body class="<?= $formStatus ? 'form-modal-open' : '' ?>">
  <header class="site-header">
    ...
    <div class="header-cta">
      ...
      <a class="btn btn-primary" href="tel:+15187207248">Get Free Estimate</a>
    </div>
  </header>
    ...
    <section class="hero" id="home">
      <div class="hero-content">
        ...
        <div class="hero-actions">
          <a class="btn btn-primary" href="tel:+15187207248">Get Free Estimate <span class="link-icon" aria-hidden="true"></span></a>
